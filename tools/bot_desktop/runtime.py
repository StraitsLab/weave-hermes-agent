...
def state_dir() -> Path:
    override = os.environ.get("HERMES_BD_STATE_DIR")  # fork: short private dir (AF_UNIX limit); UPSTREAM.md
    return Path(override) if override else get_hermes_home() / "bot-desktop"
